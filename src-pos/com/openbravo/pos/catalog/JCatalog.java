...
import com.openbravo.pos.ticket.AssortmentInfo;
...
public class JCatalog extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    private CategoryInfo showingcategory = null;
	 ...
	 private SentenceList assortmentsSentenceList;
    private ListKeyed assortmentsCollection;
    private ComboBoxValModel assortmentsModel;
     ...
     * @param dlSales
     */
    public JCatalog(DataLogicSales dlSales) throws BasicException {
     ...
     * @param height
     */
    public JCatalog(DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int width, int height) throws BasicException {
...
//        m_jListCategories.getPreferredScrollableViewportSize().setSize(400, height); 
        ...
        m_jscrollcat.getVerticalScrollBar().setPreferredSize(new Dimension(48, 48));
			...
			// N Deppe Aug 22 2015 - Added for assortments
			try {
				assortmentsSentenceList = dlSales.getAssortmentsList();
				java.util.List<AssortmentInfo> assortmentsList = assortmentsSentenceList.list();
				assortmentsCollection = new ListKeyed<>(assortmentsList);
				assortmentsModel = new ComboBoxValModel(assortmentsList);
				m_jAssortments.setModel(assortmentsModel);
			} catch (BasicException AssortmentsException) {
				// uh oh
...
// ADDED JDL 09.04.13 TEXT TIP FUNCTION  
   ...
   private void initComponents() {
      ...
      m_jAssortments = new javax.swing.JComboBox();
      ...
      jLabel1.setText("Assortment Filter");
      jPanel6.add(jLabel1);

      m_jAssortments.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
      jPanel6.add(m_jAssortments);

      m_jRootCategories.add(jPanel6, java.awt.BorderLayout.PAGE_START);
   ...
   private javax.swing.JComboBox m_jAssortments;
